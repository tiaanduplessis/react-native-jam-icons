...
var Gamepad = function Gamepad(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactNativeSvg.Circle, { className: "st0", cx: 49, cy: 13, r: 2 }),
    _react2.default.createElement(_reactNativeSvg.Circle, { className: "st0", cx: 49, cy: 23, r: 2 }),
    _react2.default.createElement(_reactNativeSvg.Circle, { className: "st0", cx: 44, cy: 18, r: 2 }),
    _react2.default.createElement(_reactNativeSvg.Circle, { className: "st0", cx: 54, cy: 18, r: 2 }),
    _react2.default.createElement(_reactNativeSvg.Path, {
      className: "st0",
